...
namespace Remp\Mailer\Components\GeneratorWidgets\Widgets\TldrWidget;

use Nette\Application\Responses\JsonResponse;
use Nette\Application\UI\Form;
use Nette\Http\Session;
use Remp\Mailer\Forms\TldrTemplateFormFactory;
...
class TldrWidget extends BaseControl implements IGeneratorWidget
{
    private string $templateName = 'tldr_widget.latte';
    ...
    public function __construct(
        ...
        private TldrTemplateFormFactory $tldrTemplateFormFactory,
    ...
    public function handleTldrPreview(): void
    {
