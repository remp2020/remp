...
namespace Remp\Mailer\Components\GeneratorWidgets\Widgets\NovydenikNewsfilterWidget;

use Nette\Application\Responses\JsonResponse;
use Nette\Application\UI\Form;
use Nette\Http\Session;
use Remp\Mailer\Forms\NovydenikNewsfilterTemplateFormFactory;
...
{
    private string $templateName = 'novydenik_newsfilter_widget.latte';
    ...
    public function __construct(
        ...
        private NovydenikNewsfilterTemplateFormFactory $newsfilterTemplateFormFactory,
