...
namespace Remp\Mailer\Components\GeneratorWidgets\Widgets\RespektUrlParserWidget;

use Nette\Application\Responses\JsonResponse;
use Nette\Application\UI\Form;
use Nette\Http\Session;
use Remp\Mailer\Forms\RespektUrlParserTemplateFormFactory;
...
class RespektUrlParserWidget extends BaseControl implements IGeneratorWidget
{
    private string $templateName = 'respekt_url_parser_widget.latte';

    public function __construct(
        private readonly Session $session,
        private readonly RespektUrlParserTemplateFormFactory $templateFormFactory,
