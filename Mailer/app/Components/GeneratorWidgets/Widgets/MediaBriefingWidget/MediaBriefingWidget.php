...
namespace Remp\Mailer\Components\GeneratorWidgets\Widgets\MediaBriefingWidget;

use Nette\Application\Responses\JsonResponse;
use Nette\Application\UI\Form;
use Nette\Http\Session;
use Remp\Mailer\Forms\MediaBriefingTemplateFormFactory;
...
{
    private string $templateName = 'mediabriefing_widget.latte';
    ...
    public function __construct(
        ...
        private MediaBriefingTemplateFormFactory $mediaBriefingTemplateFormFactory,
    ...
    public function handleMediaBriefingPreview(): void
    {
