...
namespace Remp\Mailer\Components\GeneratorWidgets\Widgets\GrafdnaWidget;

use Nette\Application\Responses\JsonResponse;
use Nette\Application\UI\Form;
use Nette\Http\Session;
use Remp\Mailer\Forms\GrafdnaTemplateFormFactory;
...
class GrafdnaWidget extends BaseControl implements IGeneratorWidget
{
    ...
    public function createComponentGrafdnaTemplateForm(): Form
    {
        $form = $this->grafdnaTemplateFormFactory->create();
        $this->grafdnaTemplateFormFactory->onSave = function () {
            $this->getPresenter()->flashMessage("Grafdna batches were created and run.");
    ...
    public function handleGrafdnaPreview(): void
    {
