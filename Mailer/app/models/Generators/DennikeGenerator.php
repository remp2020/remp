...
use Remp\MailerModule\Components\GeneratorWidgets\Widgets\DennikeWidget;
...
class DennikeGenerator implements IGenerator
{
    ...
    public function process($values)
    {
        ...
        $this->articleLocker->setupLockLink('Přidejte se k předplatitelům', 'https://predplatne.dennikn.sk/ecko');
        ...
        $rules = [
            ...
            // replace ul & /ul
            '/<ul.*?>/is' => '<table style="border-spacing:0;border-collapse:collapse;vertical-align:top;color:#181818;padding:0;margin:0;Margin:0;line-height:1.3;text-align:left;font-family:\'Helvetica Neue\', Helvetica, Arial;width:100%;margin-bottom: 26px;"><tbody>',
    ...
    public function preprocessParameters($data): ArrayHash
    {
        ...
        $output->dennike_html = $data->post_content;
...
HTML;
    ...
    <tr style="padding:0;vertical-align:top;text-align:left;">
        ...
        <td style="padding:0;vertical-align:top;text-align:left;font-size:18px;line-height:1.6;border-collapse:collapse !important;">
            <p style="margin:0 0 0 26px;Margin:0 0 0 26px;color:#181818;padding:0;margin:0;Margin:0;line-height:1.3;font-size:18px;line-height:1.6;margin-bottom:0px;Margin-bottom:0px;line-height:160%;text-align:left;font-weight:normal;word-wrap:break-word;-webkit-hyphens:auto;-moz-hyphens:auto;hyphens:auto;border-collapse:collapse !important; font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;">$1</p>
        </td>
    </tr>
HTML;
...
HTML;
        ...
        $imageTemplate = <<< HTML
        <img src="$1" alt="" style="outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;width:auto;max-width:100%;clear:both;display:block;margin-bottom:20px;border: 10px solid #1F3F83;">
HTML;
