...
const contextsCodeTmpl = `// Code generated by goagen {{ .version }}, command line:
// $ goagen
...
const controllersCodeTmpl = `// Code generated by goagen {{ .version }}, command line:
// $ goagen
// --out=$(GOPATH){{sep}}src{{sep}}{{.tmpDir}}
// --design={{.design}}
// --version={{.version}}
...
const hrefsCodeTmpl = `// Code generated by goagen {{.version}}, command line:
// $ goagen
// --out=$(GOPATH){{sep}}src{{sep}}{{.tmpDir}}
// --design={{.design}}
// --version={{.version}}
...
const mediaTypesCodeTmpl = `// Code generated by goagen {{ .version }}, command line:
// $ goagen
// --out=$(GOPATH){{sep}}src{{sep}}{{.tmpDir}}
// --design={{.design}}
// --version={{.version}}
