...
CREATE TABLE `article_aggregated_views` (
  ...
  `browser_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `date` date NOT NULL,
...
CREATE TABLE `article_titles` (
  ...
  `title` varchar(768) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `article_views_snapshots` (
  ...
  `property_token` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `external_article_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `referer_medium` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `articles` (
  ...
  `title` varchar(768) COLLATE utf8mb4_unicode_ci NOT NULL,
  `url` varchar(768) COLLATE utf8mb4_unicode_ci NOT NULL,
  `content_type` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `image_url` varchar(768) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `configs` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `config_category_id` int unsigned DEFAULT NULL,
  `name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `display_name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `conversion_commerce_events` (
  ...
  `funnel_id` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `amount` double DEFAULT NULL,
  `currency` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rtm_campaign` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rtm_content` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rtm_medium` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rtm_source` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `conversion_sources` (
  ...
  `referer_medium` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `referer_source` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `referer_host_with_path` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `newsletters` (
  ...
  `mail_type_code` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `timespan` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `state` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `email_subject` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `email_from` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `segment_browsers` (
  ...
  `browser_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `segment_rules` (
  ...
  `event_action` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `timespan` int DEFAULT NULL,
  `count` int NOT NULL,
  `fields` longtext COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'JSON encoded fields',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `operator` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `flags` longtext COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'JSON encoded flags',
  PRIMARY KEY (`id`),
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (43,'2019_01_31_142723_create_article_aggregated_views_with_id_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (44,'2019_02_06_144306_lock_author_segments_configuration',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (45,'2019_02_20_113557_alter_newsletters_change_timespan_type',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (46,'2019_06_13_111140_create_article_views_snapshots_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (47,'2019_07_02_082320_removing_paid_at_defaults',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (48,'2019_09_05_085126_make_configs_property_specific',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (49,'2019_09_05_093404_create_config_categories_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (50,'2019_09_05_223346_seed_config_values3',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (51,'2019_10_03_181106_make_title_nullable_in_article_titles_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (52,'2019_11_07_153448_add_indexes_to_article_views_snapshots',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (53,'2019_12_03_123733_create_referer_medium_labels_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (54,'2020_01_31_140157_article_tags',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (55,'2020_02_18_201353_remove_unused_columns_in_article_views_snapshots',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (56,'2020_03_18_122311_add_external_id_column_to_sections_tags_authors_tables',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (57,'2020_04_06_120804_add_indexes_to_segments',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (58,'2020_07_28_091554_create_conversion_sources_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (59,'2020_08_07_114042_remove_locked_column_in_configs',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (60,'2020_08_07_122341_seed_author_segments_config_category',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (61,'2020_08_27_111750_add_content_type_to_articles',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (62,'2020_09_18_114850_alter_segment_rules_pageview_load_flags',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (63,'2020_10_09_131803_alter_conversions_remove_on_update_from_paid_at_column',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (64,'2020_11_09_081647_create_sections_segment_group',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (65,'2020_11_13_093901_seed_section_segment_config_category_and_values',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (66,'2020_12_02_090920_change_authors_segment_days_threshold_description',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (67,'2020_12_04_145757_convert_utm_to_rtm',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (68,'2020_12_16_102140_article_content_type_index',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (69,'2021_05_06_135333_create_tag_categories_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (70,'2021_05_06_142318_create_tag_tag_categories_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (71,'2021_05_11_113758_article_pageviews_indexes',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (72,'2021_05_31_000000_add_uuid_to_failed_jobs_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (73,'2021_06_10_141729_purge_invalid_aggregated_data',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (74,'2021_11_08_084315_add_index_to_conversions_paid_at_column',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (75,'2022_02_25_130852_dashboard_articles',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (76,'2023_04_04_070759_article_views_snapshots_add_index_time_property_token',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (77,'2023_09_07_080805_create_article_meta_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (78,'2024_04_15_131551_remove_configs_autoload_flag',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (79,'2024_07_29_045343_drop_pageview_devices_and_referers',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (80,'2026_06_05_000000_properties_uuid_unique_index',1);
