...
{
    /**
     * Retention rules array describes [INTERVAL_START, INTERVAL_END, WINDOW_SIZE], all in minutes
     */
    const RETENTION_RULES = [
        [0, 10, 1], // in interval [0, 10) minutes, keep snapshot every minute
        [10, 60, 5], // in interval [10, 60) minutes, keep snapshot max every 5 minutes
        [60, 60*24, 20], // [60m, 1d)
        [60*24 , 60*24*7, 60], // [1d, 7d)
        [60*24*7 , 60*24*30, 120], // [7d, 30d)
        [60*24*30 , 60*24*90, 180], // [30d, 90d)
        [60*24*90 , 60*24*180, 360], // [90d, 180d)
        [60*24*180 , 60*24*365, 720], // [180d, 1y)
        [60*24*365 , null, 1440], // [1y, unlimited)
    ];
