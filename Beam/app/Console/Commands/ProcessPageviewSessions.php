    ...
    public function handle(
        ...
        foreach ($pageviews as $record) {
            foreach ($record->pageviews as $pageview) {
                ...
                $deviceData['os_name'] = $os['name'];
                $deviceData['os_version'] = $os['version'];
                $deviceData['client_type'] = $client['type'];
                $deviceData['client_name'] = $client['name'];
                $deviceData['client_version'] = $client['version'];
