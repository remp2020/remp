    ...
    prodlib.iota = {
        ...
        init: function(config) {
            if (typeof config.iota !== 'object') {
                throw "remplib: configuration tracker invalid or missing: "+config.iota
            }
            ...
            if (typeof config.iota.idCallback !== 'function') {
                throw "remplib: configuration iota.idCallback invalid or missing: "+config.iota.idCallback
            }
            ...
            if (typeof config.iota.targetElementCallback !== 'undefined') {
                if (! config.iota.targetElementCallback instanceof Function) {
                    throw "remplib: configuration iota.targetElementCallback invalid: "+config.iota.targetElementCallback
                }
            ...
            if (typeof config.iota.httpHeaders !== 'undefined') {
                if (! config.iota.httpHeaders instanceof Object) {
                    throw "remplib: configuration iota.httpHeaders invalid: "+config.iota.httpHeaders
                }
