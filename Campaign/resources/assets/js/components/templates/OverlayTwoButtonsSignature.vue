                ...
                <div role="tabpanel" class="active tab-pane" id="overlay-two-buttons-signature">
                    ...
                    <div class="card-body card-padding p-l-15">
                        <div class="input-group fg-float m-t-30">
                            ...
                            <div><small>Single new lines are converted to <code>&lt;br&gt;</code>, double new lines to <code>&lt;p&gt;</code></small></div>
                        </div><!-- .input-group -->
                        ...
                        <div class="input-group fg-float m-t-30">
                            ...
                            <div><small>If not set, secondary button disappears</small></div>
                        </div><!-- .input-group -->
