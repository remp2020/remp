...
use App\Contracts\SegmentCacheException;
use App\Http\Requests\SegmentCacheRequest;
use Carbon\Carbon;
    ...
    public function addUserToCache(SegmentCacheRequest $request): JsonResponse
    {
        ...
        try {
            $campaignSegment = CampaignSegment::select()
                ...
                ->whereIn('schedules.status', [\App\Schedule::STATUS_READY, \App\Schedule::STATUS_EXECUTED, \App\Schedule::STATUS_PAUSED])
